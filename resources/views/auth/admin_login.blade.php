...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('../images/favicon.ico') }}../images/favicon.ico">

    <title>FineCart Admin - Log in </title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
							...
							<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username" >
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
	...
	<!-- Vendor JS -->
	<script src="{{ asset('backemnd/js/vendors.min.js') }}"></script>
